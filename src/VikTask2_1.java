...
записать их в файл пропертей (java class Properties). Потом прочитать и обратно вывести все в консоль*/
public class VikTask2_1 {

		
	public static void main(String[] args) throws IOException {
		
		System.out.println("Введите два параметра через пробел:");
